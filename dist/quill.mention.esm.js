  ...
  _createClass(Mention, [{
    ...
    value: function getItemData() {
      ...
      if (hasLinkValue) {
        ...
        if (hasLinkDocument) {
          this.mentionList.childNodes[this.itemIndex].dataset.value = "<a href=\"".concat(link, "\" target=").concat(itemTarget || this.options.linkTarget, " >").concat(this.mentionList.childNodes[this.itemIndex].dataset.value, "<span>").concat(linkDocument, "<span>");
        } else {
